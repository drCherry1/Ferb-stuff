...
st.write(
    "Fill in your information and create "
...
st.write(
    "Enter your subject names and marks "
    "to calculate your grades, percentage, and GPA."
)
...
def calculate_grades():
    ...
    for i in range(
        ...
        subject_name = st.session_state.get(
            f"subject_name_{i}",
...
if st.session_state.grade_results is not None:
    ...
    if results["overall_grade"] in [
        ...
        st.error(
            ...
            "🌟 Don't be discouraged! Every result "
            "is a chance to learn. Keep studying, "
            "practice regularly, and try again! 💪📚"
